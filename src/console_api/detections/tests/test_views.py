...
#         self.assertEqual(response.data.get("count"), self._DETECTIONS_COUNT)
#         self.assertEqual(response.data.get("next", ""), None)
#         self.assertEqual(response.data.get("previous", ""), None)

#         for i in range(self._DETECTIONS_COUNT):
...
#                     self._DETECTIONS_COUNT,
#                 )

#                 results = response.data.get("results")

#                 self.assertEqual(len(results), self._DETECTIONS_COUNT)
...
#         log_number = secrets.randbelow(self._DETECTIONS_COUNT - 1)
